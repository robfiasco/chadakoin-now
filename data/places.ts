...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    categories: ['food'],
    icon: 'restaurant-outline',
    description: 'Classic Jamestown diner — retro feel, breakfast and lunch, coffee. Cash only. Packed on weekend mornings for a reason.',
    address: '207 N Main St, Jamestown',
    hours: 'Mon–Tue 7am–1pm · Thu–Sun 7am–1pm · Wed Closed',
    featured: false,
