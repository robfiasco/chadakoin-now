...
export const PLACES: Place[] = [
  ...
  },
  {
    ...
    categories: ['food'],
    icon: 'restaurant-outline',
    description: 'Classic Jamestown diner — retro feel, all-day breakfast on Saturday & Sunday, homemade lunch fare, and coffee. Cash only. Packed on weekend mornings for a reason.',
    address: '207 N Main St, Jamestown',
    hours: 'Mon–Fri 6am–1pm · Sat–Sun all-day breakfast',
    featured: false,
  ...
  },
  {
    ...
    hours: 'Sun 11am–7pm · Mon–Sat 11am–10pm',
    featured: false,
  },
  ...
  },
  {
    ...
    hours: 'Sun 11am–7pm · Mon 11am–10pm · Tue 11am–11pm · Wed 11am–10pm · Thu–Sat 11am–12am',
    featured: false,
...

  {
    ...
    hours: 'Sun 10am–7pm · Mon–Sat 9am–9pm',
    featured: false,
